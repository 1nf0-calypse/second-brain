...
|---|---|---|---|---|
| `DOC-000001-claude-desktop-setup.md` | DOC-000001 | 1.1 | APPROVED | Claude Desktop lokal verbinden und veralteten Serverpfad ersetzen |
| `DOC-000002-local-index.md` | DOC-000002 | 1.0 | APPROVED | Lokalen Index aktualisieren und neu aufbauen |
| `DOC-000003-volltextsuche-und-quellen.md` | DOC-000003 | 1.0 | APPROVED | Vault durchsuchen und Trefferquellen überprüfen |
| `DOC-000004-beziehungen-erkunden.md` | DOC-000004 | 1.0 | APPROVED | Direkte Beziehungen in Obsidian und Claude erkunden |
| `GS-000001.md` | GS-000001 | 1.2 | APPROVED | Einstieg um aktivierbare begrenzte Autonomie ergänzt |
...
| `FAQ-000001-suche-und-verbindung.md` | FAQ-000001 | 1.3 | APPROVED | Fragen zu Autonomie, Budget, Pause und Reaktivierung ergänzt |
