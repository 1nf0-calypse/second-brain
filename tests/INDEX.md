...
| Pfad | Abdeckung |
|---|---|
| `unit/` | Infrastrukturfreie Delta-, Vertrags-, Relationship- und Mutations-Clientlogik |
| `security/` | Vault-Root, Traversal und Fremdpfade |
| `integration/` | Index, Suche, Graph sowie bestätigte Mutationen über Service, CLI und MCP/stdio |
